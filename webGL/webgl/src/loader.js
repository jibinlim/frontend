...
export default class Edukit {
    ...
    async fileload(scene) {
        ...
        body.position.x = -15
        body.scale.set(.0005, .0005, .0005)
        const mesh1 = this.object.mesh1 = await this.loader.loadAsync("files/StaticMesh1.FBX");
        const mesh2 = this.object.mesh2 = await this.loader.loadAsync("files/StaticMesh2.FBX");
        const mesh3 = this.object.mesh3 = await this.loader.loadAsync("files/StaticMesh3.FBX");
        const mesh4 = this.object.mesh4 = await this.loader.loadAsync("files/StaticMesh4.FBX");
